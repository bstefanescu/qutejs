...
var Qute = _interopDefault(require('@qutejs/runtime'));
var Compiler = _interopDefault(require('@qutejs/compiler'));
var commons = require('@qutejs/commons');
...
function Loader() {
	this.createScript = function(code, name) {
		...
		script.name = comp ? name || commons.capitalizeFirst(commons.kebabToCamel(comp.prototype.$tag)) : null;
		script.code = code;
		script.deps = deps;
		script.comp = comp;
